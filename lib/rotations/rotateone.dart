...
class _RotateOneHexagramState extends State<RotateOneHexagram> {
  ...
  var _dropdownvalue = hexagramslist[1],
      _dropdowichingvalue = orderiChingFontHexagrams[0],
                    ...
                    DropdownButton(
                      ...
                      onChanged: (String? _dropdowichingvalueChange) {
                        setState(() {
                          ...
                          _fontindex = orderiChingFontHexagrams.indexWhere(
                              (element) => element == _dropdowichingvalue);
                          _fonthexconverted = fontHexbyWheel[_fontindex];

                          _controllerhexadjtext.text = hexagramAdjectiveList[
                              fontHexbyWheel[_fontindex]];
                          _controllerhexsubtext.text = hexagramSubjectList[
                              fontHexbyWheel[_fontindex]];
                          _controllerhexverbtext.text = hexagramVerbList[
                              fontHexbyWheel[_fontindex]];
