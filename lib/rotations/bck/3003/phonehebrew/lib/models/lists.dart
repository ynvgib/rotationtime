...
const String maintitleEN = 'זמן סיבוב',
    language = 'ENGLISH';

const String maintitleEN_bck = 'Rotation Time';
...
final List<String> subtitlesEN = [
  'מורכב',
  'פשוט',
  'אני לא יודעת מדיטציה',
  'נשימה',
  'שתיקה'
];

final List<String> subtitlesEN_bck = [
  'Complex Planets',
  'Complex Sentence',
  'Complex HD XIO',
  'Simple IT @ Table',
...
final List<String> mainroutes_bck = [
  '/rotateplanets',
  '/rotatecomplexone',
  '/rotatesimplehd',
  '/rotatehexagramtable',
...
final List hexSentenceList_bck = [
  0,
  'Adjective',
  'Subject',
  'Verb',
...
final List<String> hexNamesList_bck = [
  'COMPLEX',
  'Simple',
  'Breath',
  'silence',
