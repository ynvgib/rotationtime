...
// import 'package:finallyicanlearn/lib/models/rotateclasses.dart';
...
// comment //https:// comment //t.me/idonotknowbot_bot
...
//   static init() async {
//     // comment //final envVars = Platform.environment;
//     const username = 'idonotknow_link';
//     DateTime now = DateTime.now();
//     // comment //DateTime chosentime = DateTime.now();
...
//     // comment //final envVars = Platform.environment;
//     // comment //final telegramkey =
//        // comment // Telegram('6071566670:AAFuNgvHHr-n4CNN14eX_tIyQWqXsQy-BiU');
//     // comment //final username = (await Telegram(envVars['6071566670:AAFuNgvHHr-n4CNN14eX_tIyQWqXsQy-BiU']!).getMe()).username;

//     // comment // TeleDart uses longpoll by default if no update fetcher is specified.
//     var teledart = TeleDart(
//         '6071566670:AAFuNgvHHr-n4CNN14eX_tIyQWqXsQy-BiU', Event(username));

//     teledart.start();

//     // comment // You can listen to messages like this
//     teledart.onMessage(entityType: 'bot_command', keyword: 'start').listen(
//         (message) =>
//             teledart.sendMessage(message.chat.id, 'זמן להתארגז בים סיבוב'));

//     // comment // Sick of boilerplates? Reply messages like below, nice and tidy
//     // comment // Short hands also available for answer query methods
...
//           '???');
//       message.replyPhoto(
//           'https:// comment //m.media-amazon.com/images/I/713W7mczhvL._AC_UF1000,1000_QL80_.jpg',
...
//       message.replyPhoto(
//           'https:// comment //w7.pngwing.com/pngs/641/127/png-transparent-casino-chips-poker-cards-gambling-game-deck-yellow-blue-green-thumbnail.png',
//           caption: 'זמן להתארגז');
...
//               'https:// comment //dateful.com/time-zone-converter');

//       teledart
//           .onMessage(keyword: RegExp(r'\d{4}-\d{2}-\d{2} \d{2}:\d{2}$'))
//           .listen((message) async {
//         // comment //print(message.text);
//         // comment //DateTime now = DateTime.parse(message.text!), designTime;
...
//         // comment //List<String> hdbasicdata = HDServices.getHDBasicData(channelsList);
...
//           case 'מורכב':
//             message.replyPhoto(
//                 'https:// comment //img.freepik.com/premium-vector/eggplant-cartoon-character_193274-108.jpg',
//                 caption: 'חזי בימשו היזם');
//             message.reply(rturlcoin[0]);
//             break;
//           case 'פשוט':
//             message.replyPhoto(
//                 'https:// comment //img.freepik.com/premium-vector/cute-avocado-sleep-well-illustration_608812-923.jpg',
//                 caption: 'אבי בים טיפה בים');
//             message.reply(rturlcoin[1]);
//             break;
//           case 'נשימה':
//             message.replyPhoto(
//                 'https:// comment //img.freepik.com/premium-vector/banana-teacher-cartoon-character_193274-3355.jpg',
//                 caption: 'ביני מתווכת');
//             message.reply(rturlcoin[2]);
//             break;
//           case 'שתיקה':
//             message.replyPhoto(
//                 'https:// comment //static.vecteezy.com/system/resources/thumbnails/001/949/336/small_2x/tomato-cartoon-character-with-happy-face-expression-on-white-background-free-vector.jpg',
//                 caption: 'בטיבטי');
//             message.reply(rturlcoin[3]);
//             break;
//           default:
//             message.replyPhoto(
//                 'https:// comment //static.wixstatic.com/media/702c29_153bff0fc18844b99999271688b56bc2~mv2.png',
...
//     // comment // You can even filter streams with stream processing methods
//     // comment // See: https:// comment //www.dartlang.org/tutorials/language/streams#methods-that-modify-a-stream
//     teledart
//         .onMessage(keyword: 'rotation')
//         .where((message) => message.text?.contains('photo') ?? false)
//         .listen((message) => message.replyPhoto(
//             // comment //  io.File('example/dash_paper_plane.png'),
//             'https:// comment //png.pngtree.com/png-clipart/20190905/original/pngtree-bald-question-mark-face-png-picture-material-png-image_4533929.jpg',
//             caption: 'This is how You don\'t know'));

//     // comment //teledart
//   }

//   // comment // Text of the message to be sent, 1-4096 characters after entities parsing
//   // comment // https:// comment //core.telegram.org/bots/api#sendmessage
