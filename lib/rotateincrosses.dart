...
class _RotateInCrossesState extends State<RotateInCrosses> {
  ...
  var dropdownfirstvalue = hexagramslist[1],
      ...
      dropdownactionvalue = hexagramslist[1],
      dropdownactionichingvalue = orderiChingFontHexagrams[0],
      dropdownactionichingordervalue = orderHexagramsWheel[0],
      dropdownactionhexwhole= orderHexagramsWheel[0],
      dropdownactionhexleftcolumns = orderHexagramsWheel[0],
      dropdownactionhexrightcolumns = orderHexagramsWheel[0],
      fonthexindex = 0;

  String fonthexconverted = '1';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          actions: [
            DropdownButton(
              value: dropdownactionhexleftcolumns,
              icon:
              const Icon(Icons.keyboard_arrow_down, color: Colors.black),
              items: orderHexagramsWheelList,
              onChanged: (String? dropdownactionhexleftcolumnsChange) {
                setState(() {
                  dropdownactionhexleftcolumns =
                  dropdownactionhexleftcolumnsChange!;

                  switch (dropdownactionhexleftcolumns) {
                  //Quarter of Mutation
                    case '1':
            ...
            DropdownButton(
              value: dropdownactionhexrightcolumns,
              icon:
              const Icon(Icons.keyboard_arrow_down, color: Colors.black),
              items: orderHexagramsWheelList,
              onChanged: (String? dropdownactionhexrightcolumnsChange) {
                setState(() {
                  dropdownactionhexrightcolumns =
                  dropdownactionhexrightcolumnsChange!;

                  switch (dropdownactionhexrightcolumns) {
                  //Quarter of Mutation
                    case '7':
            ...
            const SizedBox(width: 40),
            DropdownButton(
                value: dropdownactionhexwhole,
                icon:
                const Icon(Icons.keyboard_arrow_down, color: Colors.black),
                items: orderHexagramsWheelList,
                onChanged: (String? dropdownactionhexwholeChange) {
                  setState(() {
                    dropdownactionhexwhole =
                    dropdownactionhexwholeChange!;

                    switch (dropdownactionhexwhole) {
                    //Quarter of Mutation
                      case '1':
                        _controllerfirsttop.jumpToPage(3);
                        _controllerfirstmid.jumpToPage(3);
              ...
              DropdownButton(
                ...
                onChanged: (String? dropdownfirstichingvalueChange) {
                  setState(() {
                    ...
                    fonthexindex =
                    orderiChingFontHexagrams.indexWhere((element) =>
                    element == dropdownfirstichingvalue,
                    );

                    fonthexconverted =
                    fontHexbyWheel[fonthexindex];
          ...
          Expanded(
            ...
            TextField(
              decoration: InputDecoration(
                  hintText: hexagramSentenceList[0], hintStyle: const TextStyle(color: Colors.grey)),
