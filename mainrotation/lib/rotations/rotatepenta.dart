...
// /rotatehexwithlogic
// rotate one hexagram
class RotatePenta extends StatefulWidget {
  const RotatePenta({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _RotatePentaState();
  }
}

class _RotatePentaState extends State<RotatePenta> {
  int _currenttop = 0,
      _currentmid = 0,
      _currentbot = 0,
      _hexagramVal = 0,
