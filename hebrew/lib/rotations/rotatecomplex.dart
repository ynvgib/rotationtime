...
class _RotateComplexState extends State<RotateComplex> {
  ...
  String _selfreminder =
      'קודם יש לבחור זמן ואז לחזור לכאן לתזכורת';
  final String _timeselfreminder =
      'זמן מורכב ממחשבה אשר רוב האנשים פשוט לא לא תופסים';
                      ...
                      setState(() {
                        ...
                        switch (_currentconstate) {
                          ...
                          case 1:
                            ...
                            _controllerPlanetType.text = 'קודם חיים';
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: AutoSizeTextField(
                      ...
                      decoration:
                          const InputDecoration.collapsed(hintText: 'משפט'),
        ...
        child: Flex(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('לתפוס את הזמן שלך',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: 15,
            ...
            ElevatedButton(
              ...
              child: const Text('לתפוס את עכשיו במקום',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 15,
  ...
  Widget _buildDataPopUp(BuildContext context) {
    return AlertDialog(
      title: const Text('זמן עיצוב', style: TextStyle(fontSize: 15)),
      content: Column(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          TextField(
          ...
          TextField(
              ...
              maxLines: 2,
              decoration:
                  const InputDecoration.collapsed(hintText: 'לא יודעת? שבי על דלעת'),
          ...
          Flex(
            ...
            children: [
              ElevatedButton(
                  ...
                  child: const Text('פיל צייד מקצועי', style: TextStyle(fontSize: 13))),
              ElevatedButton(
                  onPressed: () {
                    showDialog(
                      context: context,
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.blue),
                  child: const Text('תחנות', style: TextStyle(fontSize: 13))),
              ElevatedButton(
                  onPressed: () {
                    showDialog(
                      context: context,
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.blue),
                  child:
                      const Text('טרנזקציות', style: TextStyle(fontSize: 13))),
            ],
          ),
        ],
      ),
  ...
  Widget _buildProfilePopUp(BuildContext context) {
    return AlertDialog(
      title: const Text('פיל צייד מקצועי'),
      content: Column(
        children: [
          Flex(
            direction: Axis.vertical,
  ...
  void _controlHDData(HumanDesign hdbasicdata) {
    _controllerFinalLine.text = 'לא יודעת? שבי על דלעת';
  ...
  void _setDateTime(DateTime _timedata) {
    _formattedDate = DateFormat('yyyy-MM-dd').format(_timedata);
    _formattedTime = DateFormat.Hms().format(_timedata);
  ...
  void _changeTextLevels(String textlevel) {
    switch (textlevel) {
      ...
      case 'נשימה':
        ...
        _controllerNorthNodeGate.text = 'לנשום';
        ...
        _controllerDesignNorthNodeGate.text = 'לנשום';
