      ...
      body: Column(
        ...
        children: [
          ...
          AutoSizeTextField(
              maxFontSize: 30,
                readOnly: false,
                decoration: const InputDecoration.collapsed(hintText: '?גמל'),
          ...
          AutoSizeTextField(
              maxFontSize: 30,
                readOnly: false,
                decoration: const InputDecoration.collapsed(hintText: '!כלב'),
                textAlign: TextAlign.center,
          ...
          const AutoSizeText('אני לא יודעת',
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 20.0,
                  fontWeight: FontWeight.bold)),
          const Divider(thickness: 5, color: Colors.black),
          const AutoSizeText('מדיטציה',
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 20.0,
                  fontWeight: FontWeight.bold)),
