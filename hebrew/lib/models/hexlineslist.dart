...
final List idonotknowlinesList = [
  ...
  'סבא',
  1,
  'סבתא דוחה את גן עדן המורכב מפני האדמה',
  'אמא דוחה את עצמה מגן עדן המורכב על האדמה',
  'בת דוחה את גן עדן המורכב מאמהותיה על האדמה',
  'הבן יוצר גן עדן מורכב ליוצרים',
  'אבא יוצר גן עדן מורכב לעולם',
  'סבא יוצר גן עדן מורכב לשמיים',
  2,
  'שתיקת החיים של האדמה מתקבלת על ידי סבתא',
  'שתיקת החיים של אמא מתקבלת על ידי האדמה',
  'שתיקת החיים של הבת מתקבלת על ידי אמהותיה',
  'שתיקת החיים של הבן כבדה אל אחותו',
  'שתיקת החיים של אבא אינה ברוכה בעולם',
  'שתיקת החיים של סבא היא גהנום',
  3,
  'השוני השפוט של סבתא רועם הרחק מהאדמה',
  'השוני הפשוט של אמא הינו הארקת הרעם',
  'שתיקת הבת רועמת באופן שונה',
  'שתיקת הבן שופכת מים על אחותו השונה',
  'אבא פשוט משקה העולם באופן שונה',
  'סבא פשוט שופך ממטרים כבדים',
  4,
  'שאיפת סבתא תשקה תשובות מקורקעות',
  'נשיפת אמא תשפוך תשובות קלות מדי',
  'שתיקת הבת תשיב את המים',
  'שתיקת הבן תשיב הר כבד על אחותו',
  'שאיפת אבא תשב בכבדות על הר העולם',
  'נשיפת סבא תשיב את ההר לשמיים',
  5,
  'מצב ההמתנה המורכב של סבתא ידחוף את השמיים מהאדמה',
  'מצב ההמתנה המורכב של אמא ירחיק אותה לעבר השמיים',
  'הבת פשוט תמתין לדחוף את אחיה מעלה',
  'הבן פשוט ימתין להיות נטל על אחותו',
  'אבא פשוט ימתין להשקות את העולם',
  'סבא פשוט ימתין לדחות גשם מהשמיים',
  6,
  'שאיפת סבתא - חיכוך מים על אדמה שמורה',
  'נשיפת אמא - טביעת החיכוך במים',
  'שאיפת הבת - חיכוך בהיר במים',
  'שאיפת הבן - חיכוך השמיים מכביד על אחותו',
  'אבא מורכב - חיכוך בהארה עולמית',
  'סבא מורכב - חיכוך בדלת גן עדן',
  7,
  'סבתא תשאף לתפקד עם מים עמוקים',
  'אמא תנשוף לתפקד במים עכורים טרם זמנה',
  'הבת תתפקד בשתיקה כאמהותיה',
  'הבן יתפקד בשתיקה כנטל לאחותו',
  'אבא יתפקד בשתיקה כדי להעמיס על העולם',
  'סבא יתפקד בשתיקה כדי להפוך חיי כולם לגהנום',
  8,
  'סבא תורמת לקרקע שתיקה עמוקה',
  'אמא תורמת לטבע את שתיקתה',
  'הבת תורמת בשתיקה כדי להעצים את אמהותיה',
  'הבן תורם בשתיקה כדי להעמיס על אחותו',
  'אבא פשוט תורם כדי לשפוך גשם על כל העולם',
  'סבא פשוט תורם כדי להטביע את המורשת שלו',
  9,
  'סבתא תתמקד באופן מורכב לא מקורקע כלל',
  'אמא תתמקד באופן מורכב שאינו מקרקע אותה',
  'בת תתמקד באופן פשוט כדי לברוח מאמא שלה',
  'בן יתמקד באופן פשוט כדי להיות לעול לאחותו',
  'אבא יתמקד באופן מורכב כדי לטהר את רוח העולם',
  'סבא יתמקד באופן מורכב כדי לעוף עם הרוח אל על',
  10,
  'סבתא מתנהגת באופן מורכב בצד האגם מוקדם מדי',
  'אמא מתנהגת באופן מורכב טרם זמנה',
  'בת שואפת להתנהג כדי להעצים את אמא',
  'בן נושף התנהגות אשר מתוגמלת באהבה',
  'אבא מתנהג באופן מורכב כדי להציל את העולם עצמו',
  'סבא מתנהג באופן מורכב כדי לתפקד כדוגמן גן עדן',
  11,
  'הרעיון המורכב של סבתא פרח טרם זמנו על האדמה',
  'הרעיון המורכב של אמא פרח מהר מדי',
  'הרעיון הפשוט של הבת פרח הרחק מאמא',
  'הרעיון הפשוט של הבן חלף כעול על אחותו',
  'רעיון פריחת השתיקה של אבא הכביד על העולם',
  'רעיון השתיקה של סבא הכביד על המורשת שלו',
  12,
  'סבתא זהירה בשתיקה כדי להתשרש עמוק באדמה',
  'אמא זהירה בשתיקה כדי להגן על עצמה',
  'בת שואפת בזהירות כדי להעצים את אמא',
  'בן נושף בזהירות כדי להעצים את הנזהרים',
  'אבא מזהיר באופן מורכב את כוח העולם עצמו',
  'סבא מזהיר באופן מורכב ששער גן עדן פתוח',
  13,
  'הסוד הפשוט של סבתא נשרף בקלות יתרה',
  'הסוד הפשוט של אמא חימם אותה',
  'הסוד המורכב של הבת שרף את אחיה',
  'הסוד המורכב של הבן האיר את בני האדם',
  'הסוד המורכב של אבא האיר את העולם כולו',
  'הסוד המורכב של סבא האיר את שער גן עדן',
  14,
  'העושר המורכב של סבתא כבד מדי לאדמה',
  'העושר המורכב של אמא כבד לה מדי',
  'העושר המורכב של הבת דוחף את אחיה',
  'העושר המורכב של הבן מעשיר את המשפחה',
  'אבא שואף את עושר העולם בכבדות',
  'סבא נושף להעשיר את אש השמיים',
  15,
  'צניעות השתיקה של סבתא תהיה למורשת האהבה',
  'צניעות השתיקה של אמא תהיה לאהבת כל ילדיה',
  'צניעות הבת פשוט תהיה לדחוף את אחיה',
  'צניעות הבן תהיה פשוט לעול על אחותו',
  'צניעות השתיקה של אבא לא תהיה נאהבת בעולם',
  'צניעות השתיקה של סבא לא תהיה נאהבת על מורשתו',
  16,
  'סבתא תתלהב בשתיקה מהאדמה',
  'אבא תתלהב בשתיקה מעצמה על האדמה',
  'בת תשאף להתלהב כדי לקרקע את אמא',
  'בן ינשוף בהתלהבות במשפחה נלהבת',
  'אבא ישתוק בהתלהבות לא מקובלת על ידי העולם',
  'סבא ישתוק בהתלהבות לנטל על מורשתו',
  17,
  'הדעה של סבתא לא תשרת את האדמה באופן פשוט',
  'הדעה של אמא משרתת אותה על האדמה באופן פשוט',
  'הדעה הצלולה של הבת תשאף לשרת את אמא',
  'הדעה הצלולה של הבן תנשוף בעקבות אביו',
  'הדעה של אבא תעקוב באופן פשוט אחר העולם',
  'הדעה של סבא לא תעקוב באופן פשוט אחר המורשת שלו',
  18,
...
final List idonotknowOnlylinesList_eng = [
  'granny (modestmother)',
  'mama (mother)',
  'daughter (sister)',
  'son (brother)',
...
final List idkHexList = [
  ...
  'זמן יוצר ביטוי עצמי',
  'זמן מתקבל כנהג',
  'זמן משנה מהותית את הסדר',
  'זמן ישיב בשובבות',
  'זמן ימתין בסבלנות',
  'מרחב - חיכוך בעימות',
  'זמן יתפקד כמצביא',
  'זמן מחזיק יחד תרומה',
  'זמן יאלף כוח קטן ממוקד',
  'זמן צועד באהבה',
  'זמן ראה רעיון בשלווה',
  'זמן מזהיר מעמידה במקום',
  'זמן האזין לסודות בני אדם',
  'זמן מעצים עושר מיומן',
  'זמן יצניע קיצוניות',
  'זמן יתלהב במיומנות',
  'זמן יעקוב אחר הדרגות',
  'זמן יתקן סמכות מפונקת',
  'מרחב - צורך בגישה',
  'זמן מהדהד עכשיו',
  'מרחב - שלטון נושך',
  'זמן פתוח לחסד',
  'זמן מטמיע חלק מפוצל',
  'זמן חוזר אל ידיעה',
  'זמן אוהב את רוח הנפש',
  'מרחב - אילוף תעלול גדול',
  'מרחב - הזנת אכפתית',
  'זמן משחק בסיכון',
  'זמן התמיד בתוהו ובוהו',
  'זמן נאחז באש',
  'זמן ישפיע על מנהיגות',
  'מרחב - משך העמידות',
  'זמן נסוג אל זכרון פרטי',
  'זמן העצים את עצמו בכוח',
  'זמן השתנה תוך התקדמות',
  'זמן החשיך את המשבר באור',
  'מרחב - חבר במשפחה',
  'זמן נלחם מנגד',
  'זמן דוקר מכשול',
  'מרחב - עבודה נאמנה',
  'זמן הפחית הזיונות',
  'זמן הגביר את סוף הצמיחה',
  'זמן פורץ דרך תובנה',
  'מרחב - מבוא לפגישה',
  'מרחב - מאסף יחד',
  'זמן נדחף כלפי עצמו בנחישות',
  'זמן התממש בדיכוי',
  'זמן יעמיק לבאר',
  'מרחב - עקרון מהפכני',
  'מרחב - ערך הכלים',
  'זמן מזעזע שעון מעורר',
  'זמן ישמור פעולה דוממת',
  'זמן התפתח מההתחלה',
  'מרחב - שאיפה לדחוף',
  'זמן שופע ברוח',
  'זמן נאבד באמונה',
  ...
  'זמן מקבל את המגבלה',
  'זמן מסתיר את האמת',
  'זמן יפרט יתרון המחשבה',
  'זמן ישלים לאחר ספק',
  'זמן השלים לפני בלבול',
];

final List idkHexList_eng = [
